...
var MuiTable = function (_Component) {
  ...
  _createClass(MuiTable, [{
    ...
    key: 'getColumnWidthFunction',
    value: function getColumnWidthFunction() {
      var _this2 = this;
      ...
      if (typeof columnWidth === 'function') {
        return function (_ref) {
          ...
          return columnWidth({ index: index, columns: columns, width: width });
        };
      } else if (resizable) {
    ...
    value: function render() {
      ...
      var _props2 = this.props,
          ...
          fitHeightToRows = _props2.fitHeightToRows,
          ...
          props = _objectWithoutProperties(_props2, ['data', 'columns', 'width', 'height', 'maxHeight', 'pagination', 'fitHeightToRows', 'fixedRowCount', 'fixedColumnCount', 'rowHeight', 'columnWidth', 'includeHeaders', 'classes', 'orderBy', 'orderDirection', 'onHeaderClick', 'onCellClick', 'isCellHovered', 'isCellSelected', 'cellProps', 'style', 'theme', 'resizable']);
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.resizeRow = function (_ref4) {
    ...
    return _this4.setState(function (prevState) {
      ...
      var percentDelta = deltaX / _this4.props.width;
      ...
      _this4.multiGrid.recomputeGridSize();
    });
  };

  this.cellRenderer = function (_ref5) {
    var _classNames;
    ...
    var _props3 = _this4.props,
        ...
        includeHeaders = _props3.includeHeaders,
        isCellHovered = _props3.isCellHovered,
        isCellSelected = _props3.isCellSelected,
        classes = _props3.classes,
        orderBy = _props3.orderBy,
        orderDirection = _props3.orderDirection,
        onHeaderClick = _props3.onHeaderClick,
        onCellClick = _props3.onCellClick,
        resizable = _props3.resizable,
        defaultCellProps = _props3.cellProps,
        tablesortstyle = _props3.tablesortstyle;
    ...
    return _react2.default.createElement(
      ...
      _extends({
        ...
        onMouseEnter: function onMouseEnter() {
          _this4.setState({ hoveredColumn: column, hoveredRowData: rowData });
        },
        onMouseLeave: function onMouseLeave() {
          return _this4.setState({ hoveredColumn: null, hoveredRowData: null });
        },
      ...
      isHeader && column.onHeaderClick !== false && (column.onHeaderClick || onHeaderClick) ? _react2.default.createElement(
        ...
        _react2.default.createElement(
          _reactDraggable2.default,
          {
            ...
            onDrag: function onDrag(event, _ref7) {
